...
#  QUICK START GUIDE:
#
#  If this project has been created with the command "ndtkit create" from ndtkit-api cli, you can skip the first two steps
#  (the virtual environment has been already created)
#
...
#
#  3. LAUNCH NDTkit:
#     By running NDTkit, you will start the socket server that will ensure the communication between NDTkit and this project
#
#  4. LAUNCH:
