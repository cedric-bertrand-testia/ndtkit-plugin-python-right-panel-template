...
#  QUICK START GUIDE:
#
# If this project has been created using the "ndtkit create" command from the ndtkit-api cli, the two first steps can be skipped
...
#
#  3. LAUNCH NDTkit:
#     By running the software for which you are developing the plugin, you will launch its socket server so the connection between NDTkit and this plugin can be effective.
#
#  4. LAUNCH this Python Program:
#     Simply press F5 (if using VS Code) or run 'python main.py'.
#     This will start a NiceGUI local server.
#
#  5. NDTkit INTEGRATION:
